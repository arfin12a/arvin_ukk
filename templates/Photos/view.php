...
<div class="view card card-primary card-outline">
    ...
    <div class="card-body table-responsive p-0">
        <table class="table table-hover text-nowrap">
            ...
            <tr>
                <th><?= __('Foto') ?></th>
                <td><?= $this->Html->image('../upload/' . $photo->foto, ['width' => '60']) ?></td>
            </tr>
            <tr>
                <th><?= __('Id') ?></th>
...
<div class="related related-comment view card">
    <div class="card-header d-flex">
        ...
        <div class="ml-auto">
            <?= $this->Html->link(__('Komentar'), ['controller' => 'Comments', 'action' => 'add', '?' => ['photo_id' => $photo->id]], ['class' => 'btn btn-primary btn-sm']) ?>
            <?= $this->Html->link(__('Lihat komentar'), ['controller' => 'Comments', 'action' => 'index'], ['class' => 'btn btn-primary btn-sm']) ?>
        </div>
    </div>
    <div class="card-body table-responsive p-0">
        <table class="table table-hover text-nowrap">
...
<div class="related related-like view card">
    <div class="card-header d-flex">
        ...
        <div class="ml-auto">
            <?= $this->Html->link(__('Sukai'), ['controller' => 'Likes', 'action' => 'add', '?' => ['photo_id' => $photo->id]], ['class' => 'btn btn-primary btn-sm']) ?>
            <!-- <?= $this->Html->link(__(''), ['controller' => 'Likes', 'action' => 'index'], ['class' => 'btn btn-primary btn-sm']) ?> -->
        </div>
    </div>
    <div class="card-body table-responsive p-0">
        <table class="table table-hover text-nowrap">
